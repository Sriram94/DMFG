...
if __name__ == "__main__":
    ...
    for agent in parallel_env.agents:
        if 'tiger' in agent:
            ...
            new_name = agent
            RL[agent] = DMFGQL(9,2349,sess, e_greedy=1, name = new_name, e_greedy_increment=None, execution=True)

            RL[agent].restore_model("./"+agent+"/dmfgqlmodel.ckpt")
            RL[agent].restore_model_meanfield("./"+agent+"/dmfgqlmeanfieldmodel.ckpt")
