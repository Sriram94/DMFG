...
class MFQ:
    def __init__(
        ...
        self.memory = np.zeros((self.memory_size, n_features * 2 + self.n_actions + 2))
    ...
    def store_transition(self, s, a, a1, r, s_):
        ...
        transition = np.hstack((s, a1, [a, r], s_))
